...
<?php include('header.php'); ?>
	...
	<br>
	<div>
	<h2 style="padding-top:100px;text-align:center;font-size:50px;color:grey;" > STUDENT LOGIN </h2>
	</div>
...
cursor: pointer;">Login</button>
		<br>
		<span style="color:#000;">Not a member yet?</span><a href="student_registration.php" title="create a account" target="" style="color:blue">&nbsp;Sign Up</a>
