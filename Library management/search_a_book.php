...
<br>
<div>
<h2 style="padding-top:100px;text-align:center;font-size:50px;color:black;" > SEARCH A BOOK </h2>
</div>
<div class="formstyle" style="float: center;padding:25px;background-image: image(picture.jpg);white;margin-right:0px; margin-bottom:30px;padding-top:100px;">
   ...
   <div class="col-md-12">
     ...
     <table style="margin-left:auto;margin-right:auto;">
			 <tr>
				 ...
				 <td><select name="search" style=" float: center;width: =100%;
        ...
        if(!empty($_POST['search'])) {
          ...
          switch ($selected)
          {
              ...
              <tr>
                ...
                <th style='padding: 15px;background-color: black;color: white;' >  Return Date </th>              </tr>";
              ...
              <tr>
							<th style='padding: 15px;background-color: black;color: white;' >  Book ID</th>
							<th style='padding: 15px;background-color: black;color: white;' >  Book Name  </th>
							<th style='padding: 15px;background-color: black;color: white;' background-color: white;>  Author Name  </th>
							<th style='padding: 15px;background-color: black;color: white;' >  Section  </th>
							<th style='padding: 15px;background-color: black;color: white;' >  Price  </th>
							<th style='padding: 15px;background-color: black;color: white;' >  Status </th>
							<th style='padding: 15px;background-color: black;color: white;' >  Holder </th>
