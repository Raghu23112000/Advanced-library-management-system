...
<div>
<h2 style="padding-top:200px;text-align:center;font-size:50px;color:black;" > UN-AVAILABLE BOOKS </h2>
</div>
...
while($row=mysqli_fetch_assoc($res))
{
	...
	echo "<tr>"; echo $row['return_date']; echo "</td>";
	echo "<tr>"; echo $row['holder']; echo "</td>";
	echo "</tr>";
}
echo "</table>";
 ?>
