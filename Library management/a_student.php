...
<div>
<h2 style="padding-top:200px;text-align:center;font-size:50px;color:black;" > STUDENT DETAILS </h2>
</div>
...
<th style='padding: 15px;background-color: black;color: white;' >  Student ID </th>
<th style='padding: 15px;background-color: black;color: white;' >  Phone No  </th>
<th style='padding: 15px;background-color: black;color: white;' >  Roll No  </th>
<th style='padding: 15px;background-color: black;color: white;' >  Branch  </th>
<th style='padding: 15px;background-color: black;color: white;' >  Year  </th>
...
while($row=mysqli_fetch_assoc($res))
{
	...
	echo "<tr>"; echo $row['student_id']; echo "</td>";
	echo "<tr>"; echo $row['phno']; echo "</td>";
	echo "<tr>"; echo $row['rollno']; echo "</td>";
